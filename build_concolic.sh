...
CFLAGS="${ZLOG_CFLAGS} ${PROTOBUF_CLIENT_CFLAGS} ${MM_CFLAGS} -DDISABLE_STRING_INTERNING -ggdb3"
LDFLAGS="${ZLOG_LDFLAGS} ${PROTOBUF_CLIENT_LDFLAGS} ${MM_LDFLAGS}"
LIBS="${ZLOG_LIBS} ${PROTOBUF_CLIENT_LIBS} ${MM_LIBS}"
